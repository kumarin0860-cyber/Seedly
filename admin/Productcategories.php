                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    ...
                                    <label for="subject">Image_url</label>
                                </div>
                            </div>
                             <div class="col-md-6">
                                <div class="form-floating">
...
if (isset($_POST['btn'])) {
    ...
    if ($result) {
        ...
        echo "<script>window.location.assign('productcategories.php?msg=Category added Successfull')</script>";
    } else {
        echo "<script>window.location.assign('productcategories.php?err=Category Not added')</script>";
    }
}
